        ...
        <Card>
          <CardContent className="text-center py-12">
            <h2 className="text-2xl font-bold mb-4">
              {DESCRIPTIONS.AUTHENTICATION_REQUIRED}
            </h2>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="all">
                      {PLACEHOLDERS.ALL_ACTIONS}
                    </SelectItem>
                    <SelectItem value={ActivityType.USER_REGISTERED}>
                      {ACTIVITY_TYPES.USER_REGISTERED}
                    </SelectItem>
                    <SelectItem value={ActivityType.USER_LOGIN}>
                      {ACTIVITY_TYPES.USER_LOGIN}
                    </SelectItem>
                    <SelectItem value={ActivityType.GROUP_CREATED}>
                      {ACTIVITY_TYPES.GROUP_CREATED}
                    </SelectItem>
                    <SelectItem value={ActivityType.MEMBER_ADDED}>
                      {ACTIVITY_TYPES.MEMBER_ADDED}
                    </SelectItem>
                    <SelectItem value={ActivityType.SCORING_RULE_CREATED}>
                      {ACTIVITY_TYPES.SCORING_RULE_CREATED}
                    </SelectItem>
                    <SelectItem value={ActivityType.SCORE_RECORDED}>
                      {ACTIVITY_TYPES.SCORE_RECORDED}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-lg font-medium mb-2">
                {DESCRIPTIONS.NO_ACTIVITY_LOGS_FOUND}
              </p>
              <p className="text-sm">
          ...
          {pagination.totalPages > 1 && (
            <div className="flex items-center justify-between pt-6 border-t">
              <div className="text-sm text-muted-foreground">
                {DESCRIPTIONS.SHOWING_RANGE_RESULTS.replace(
                  "{start}",
                  ((pagination.page - 1) * pagination.limit + 1).toString(),
                )
                  .replace(
                    "{end}",
                    Math.min(
