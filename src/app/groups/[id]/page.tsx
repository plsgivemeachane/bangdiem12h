...
} from "@/lib/utils/vietnamese-names";
...
export default function GroupDetailPage() {
    ...
    try {
      ...
      if (error instanceof Error) {
        if (
          ...
          setError(
            "Không tìm thấy nhóm hoặc bạn không có quyền truy cập vào nhóm này.",
          );
        } else if (
  ...
  const canManageGroupPermission = canManageGroup(
    user as any,
    group?.members || [],
  );
    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
          ...
          <CardContent>
            <div className="text-lg font-bold">
              ...
              <span className="block sm:hidden">
                {getVietnameseSurname(
                  groupStats?.topPerformers?.[0]?.userName || "",
                ) || "N/A"}
              </span>
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg font-bold">
              ...
              <span className="block sm:hidden">
                {getVietnameseSurname(
                  groupStats?.bottomPerformers?.[0]?.userName || "",
                ) || "N/A"}
              </span>
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Quyền hạn của bạn</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Thiết lập cách tính điểm</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="text-sm text-muted-foreground">
                {group.scoringRules?.length || 0} quy tắc chấm điểm đang hoạt
                động
              </div>
              <Button
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Ghi và xem điểm</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="text-sm text-muted-foreground">
              ...
              <div className="space-y-2">
                {canManageGroupPermission && (
                  <Button
                    ...
                    variant="default"
                    disabled={
                      !group.scoringRules?.some((rule) => rule.isActive)
                    }
                  >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Các hoạt động mới nhất trong nhóm</CardDescription>
        </CardHeader>
        <CardContent>
          <ActivityFeed
            groupId={group.id}
