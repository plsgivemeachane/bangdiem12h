...
export interface UserRoleKeys {
  [key: string]: string;
}
export interface GroupRoleKeys {
  [key: string]: string;
}
export interface PeriodKeys {
  [key: string]: string;
}
export interface PlaceholderKeys {
  [key: string]: string;
}
export interface PageTitleKeys {
  [key: string]: string;
}
export interface DescriptionKeys {
  [key: string]: string;
}
export interface ActivityTypeKeys {
  [key: string]: string;
}
export interface UserManagementKeys {
  [key: string]: any;
}
export interface DashboardKeys {
  [key: string]: any;
}
export interface GroupsPageKeys {
  [key: string]: any;
}
export interface SigninKeys {
  [key: string]: any;
}
export interface AppHeaderKeys {
  [key: string]: string;
}
